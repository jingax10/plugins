...
var _ = Describe("ptp Operations", func() {
	...
	It("configures and deconfigures a ptp link (l2Proxy enabled) with ADD/DEL", func() {
		conf := `{
    "cniVersion": "0.3.1",
    "name": "mynet",
    "type": "ptp",
	...
	It("configures and deconfigures a dual-stack ptp link (l2Proxy enabled) with ADD/DEL", func() {
		conf := `{
    "cniVersion": "0.3.1",
    "name": "mynet",
    "type": "ptp",
